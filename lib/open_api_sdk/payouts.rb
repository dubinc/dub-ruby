...
module OpenApiSDK
  ...
  class Payouts
    ...
    def list(request:, timeout_ms: nil)
      ...
      query_params = Utils.get_query_params(Models::Operations::ListPayoutsRequest, request, nil)
      ...
      if Utils.match_status_code(http_response.status, ['200'])
        if Utils.match_content_type(content_type, 'application/json')
          ...
          obj = Crystalline.unmarshal_json(JSON.parse(response_data), Crystalline::Array.new(Models::Operations::ListPayoutsResponseBody))
