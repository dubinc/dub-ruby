...
module OpenApiSDK
  ...
  class Folders
    ...
    sig { params(request: T.nilable(Models::Operations::CreateFolderRequestBody), timeout_ms: T.nilable(Integer), http_headers: T.nilable(T::Hash[T.any(String, Symbol), String])).returns(Models::Shared::FolderSchema) }
    ...
    sig { params(id: ::String, timeout_ms: T.nilable(Integer), http_headers: T.nilable(T::Hash[T.any(String, Symbol), String])).returns(Models::Operations::DeleteFolderResponseBody) }
    ...
    sig { params(id: ::String, request_body: T.nilable(Models::Operations::UpdateFolderRequestBody), timeout_ms: T.nilable(Integer), http_headers: T.nilable(T::Hash[T.any(String, Symbol), String])).returns(Models::Shared::FolderSchema) }
