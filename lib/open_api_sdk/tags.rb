...
module OpenApiSDK
  ...
  class Tags
    ...
    def list(request:, timeout_ms: nil)
      ...
      query_params = Utils.get_query_params(Models::Operations::GetTagsRequest, request, nil)
    ...
    def delete(id:, timeout_ms: nil)
      ...
      url = Utils.generate_url(
        Models::Operations::DeleteTagRequest,
        base_url,
        '/tags/{id}',
        request
      )
      ...
      if Utils.match_status_code(http_response.status, ['200'])
        if Utils.match_content_type(content_type, 'application/json')
          ...
          response_data = http_response.env.response_body
          obj = Crystalline.unmarshal_json(JSON.parse(response_data), Models::Operations::DeleteTagResponseBody)
    ...
    def update(id:, request_body: nil, timeout_ms: nil)
      ...
      base_url = Utils.template_url(url, params)
      url = Utils.generate_url(
        Models::Operations::UpdateTagRequest,
        base_url,
        '/tags/{id}',
        request
      )
