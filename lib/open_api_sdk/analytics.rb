    ...
    def retrieve(request:, timeout_ms: nil)
      ...
      if Utils.match_status_code(http_response.status, ['200'])
        if Utils.match_content_type(content_type, 'application/json')
          ...
          obj = Crystalline.unmarshal_json(JSON.parse(response_data), Crystalline::Union.new(Models::Shared::AnalyticsCount, Crystalline::Array.new(Models::Shared::AnalyticsTimeseries), Crystalline::Array.new(Models::Shared::AnalyticsContinents), Crystalline::Array.new(Models::Shared::AnalyticsCountries), Crystalline::Array.new(Models::Shared::AnalyticsRegions), Crystalline::Array.new(Models::Shared::AnalyticsCities), Crystalline::Array.new(Models::Shared::AnalyticsDevices), Crystalline::Array.new(Models::Shared::AnalyticsBrowsers), Crystalline::Array.new(Models::Shared::AnalyticsOS), Crystalline::Array.new(Models::Shared::AnalyticsTriggers), Crystalline::Array.new(Models::Shared::AnalyticsReferers), Crystalline::Array.new(Models::Shared::AnalyticsRefererUrls), Crystalline::Array.new(Models::Shared::AnalyticsTopLinks), Crystalline::Array.new(Models::Shared::AnalyticsTopUrls)))
