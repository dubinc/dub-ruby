  ...
  module Models
    module Errors
      ...
      class InviteExpiredError
        ...
        field :code, Models::Errors::InviteExpiredCode, { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('code'), required: true, 'decoder': ::OpenApiSDK::Utils.enum_from_string(Models::Errors::InviteExpiredCode, false) } }
        ...
        sig { params(code: Models::Errors::InviteExpiredCode, message: ::String, doc_url: T.nilable(::String)).void }
