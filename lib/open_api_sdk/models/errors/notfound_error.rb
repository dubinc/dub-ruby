  ...
  module Models
    module Errors
      ...
      class NotFoundError
        ...
        field :code, Models::Errors::NotFoundCode, { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('code'), required: true, 'decoder': ::OpenApiSDK::Utils.enum_from_string(Models::Errors::NotFoundCode, false) } }
        ...
        sig { params(code: Models::Errors::NotFoundCode, message: ::String, doc_url: T.nilable(::String)).void }
