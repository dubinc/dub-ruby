  ...
  module Models
    module Errors
      ...
      class InternalServerErrorError
        ...
        field :code, Models::Errors::InternalServerErrorCode, { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('code'), required: true, 'decoder': ::OpenApiSDK::Utils.enum_from_string(Models::Errors::InternalServerErrorCode, false) } }
