  ...
  module Models
    module Errors
      ...
      class ConflictError
        ...
        field :code, Models::Errors::ConflictCode, { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('code'), required: true, 'decoder': ::OpenApiSDK::Utils.enum_from_string(Models::Errors::ConflictCode, false) } }
        ...
        sig { params(code: Models::Errors::ConflictCode, message: ::String, doc_url: T.nilable(::String)).void }
