...
module OpenApiSDK
  module Models
    module Shared
      ...
      autoload :DiscountCodeSchema, 'open_api_sdk/models/shared/discountcodeschema.rb'
      autoload :DiscountCodeWebhookEvent, 'open_api_sdk/models/shared/discountcodewebhookevent.rb'
      autoload :DiscountCodeWebhookEventData, 'open_api_sdk/models/shared/discountcodewebhookevent_data.rb'
      autoload :DiscountCodeWebhookEventEvent, 'open_api_sdk/models/shared/discountcodewebhookevent_event.rb'
      autoload :DiscountCodeWebhookEventType, 'open_api_sdk/models/shared/discountcodewebhookevent_type.rb'
      ...
      autoload :Application, 'open_api_sdk/models/shared/application.rb'
      ...
      autoload :DefaultPayoutMethod, 'open_api_sdk/models/shared/defaultpayoutmethod.rb'
      autoload :Discount, 'open_api_sdk/models/shared/discount.rb'
      autoload :Event, 'open_api_sdk/models/shared/event.rb'
      autoload :Event1, 'open_api_sdk/models/shared/event_1.rb'
      autoload :Event2, 'open_api_sdk/models/shared/event_2.rb'
      ...
      autoload :NetworkStatus, 'open_api_sdk/models/shared/networkstatus.rb'
      autoload :Options, 'open_api_sdk/models/shared/options.rb'
      autoload :Partner, 'open_api_sdk/models/shared/partner.rb'
      autoload :Provider, 'open_api_sdk/models/shared/provider.rb'
