  ...
  module Models
    module Operations
      ...
      class ListPartnersFields1
        ...
        field :constraints, Crystalline::Nilable.new(Models::Operations::ListPartnersFieldsConstraints), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('constraints') } }

        sig { params(key: ::String, label: ::String, required: T::Boolean, locked: T::Boolean, position: ::Integer, type: Models::Operations::ListPartnersFieldsType, constraints: T.nilable(Models::Operations::ListPartnersFieldsConstraints)).void }
