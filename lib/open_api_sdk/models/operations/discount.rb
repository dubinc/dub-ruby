  ...
  module Models
    module Operations
      ...
      class Discount
        ...
        field :type, Models::Operations::GetCustomersType, { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('type'), required: true, 'decoder': ::OpenApiSDK::Utils.enum_from_string(Models::Operations::GetCustomersType, false) } }
