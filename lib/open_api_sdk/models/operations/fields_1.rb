  ...
  module Models
    module Operations
      ...
      class Fields1
        ...
        field :type, Models::Operations::FieldsType, { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('type'), required: true, 'decoder': ::OpenApiSDK::Utils.enum_from_string(Models::Operations::FieldsType, false) } }

        field :constraints, Crystalline::Nilable.new(Models::Operations::Constraints), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('constraints') } }

        sig { params(key: ::String, label: ::String, required: T::Boolean, locked: T::Boolean, position: ::Integer, type: Models::Operations::FieldsType, constraints: T.nilable(Models::Operations::Constraints)).void }
