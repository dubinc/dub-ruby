  ...
  module Models
    module Operations
      ...
      class Fields1
        ...
        field :type, Models::Operations::FieldsType, { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('type'), required: true, 'decoder': Utils.enum_from_string(Models::Operations::FieldsType, false) } }
