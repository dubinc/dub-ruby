  ...
  module Models
    module Operations
      ...
      class GetCustomersResponseBody
        ...
        field :partner, Crystalline::Nilable.new(Models::Operations::GetCustomersPartner), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('partner') } }
        ...
        def initialize(id:, name:, external_id:, created_at:, email: nil, avatar: nil, stripe_customer_id: nil, country: nil, sales: nil, sale_amount: nil, link: nil, program_id: nil, partner: nil, discount: nil)
          @id = id
          @name = name
