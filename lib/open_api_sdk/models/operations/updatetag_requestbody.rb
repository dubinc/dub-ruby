  ...
  module Models
    module Operations
      ...
      class UpdateTagRequestBody
        ...
        field :color, Crystalline::Nilable.new(Models::Operations::UpdateTagColor), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('color'), 'decoder': Utils.enum_from_string(Models::Operations::UpdateTagColor, true) } }
        # The name of the tag to create.
        # 
