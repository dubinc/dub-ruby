  ...
  module Models
    module Operations
      ...
      class UpdateTagRequestBody
        ...
        field :color, Crystalline::Nilable.new(Models::Operations::UpdateTagColor), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('color'), 'decoder': ::OpenApiSDK::Utils.enum_from_string(Models::Operations::UpdateTagColor, true) } }
        # The name of the tag to create.
        #
        # @deprecated true: This will be removed in a future release, please migrate away from it as soon as possible.
        field :tag, Crystalline::Nilable.new(::String), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('tag') } }

        sig { params(name: T.nilable(::String), color: T.nilable(Models::Operations::UpdateTagColor), tag: T.nilable(::String)).void }
