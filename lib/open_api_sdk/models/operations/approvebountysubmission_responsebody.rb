  ...
  module Models
    module Operations
      ...
      class ApproveBountySubmissionResponseBody
        ...
        field :status, Models::Operations::ApproveBountySubmissionStatus, { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('status'), required: true, 'decoder': ::OpenApiSDK::Utils.enum_from_string(Models::Operations::ApproveBountySubmissionStatus, false) } }
