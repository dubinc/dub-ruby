  ...
  module Models
    module Operations
      ...
      class Customer
        ...
        sig { params(name: T.nilable(::String), email: T.nilable(::String), avatar: T.nilable(::String), external_id: T.nilable(::String)).void }
        def initialize(name: nil, email: nil, avatar: nil, external_id: nil)
          @name = name
          @email = email
          @avatar = avatar
