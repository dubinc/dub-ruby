  ...
  module Models
    module Operations
      ...
      class GetCustomerDiscount
        ...
        sig { params(id: ::String, amount: ::Float, type: Models::Operations::GetCustomerType, max_duration: T.nilable(::Float), coupon_id: T.nilable(::String), coupon_test_id: T.nilable(::String), description: T.nilable(::String), partners_count: T.nilable(::Float)).void }
