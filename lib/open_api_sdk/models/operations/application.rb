  ...
  module Models
    module Operations
      ...
      class Application
        ...
        field :rejection_reason, Crystalline::Nilable.new(Models::Operations::ListPartnersRejectionReason), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('rejectionReason'), required: true, 'decoder': ::OpenApiSDK::Utils.enum_from_string(Models::Operations::ListPartnersRejectionReason, false) } }
        ...
        sig { params(rejection_reason: T.nilable(Models::Operations::ListPartnersRejectionReason), rejection_note: T.nilable(::String), reviewed_at: T.nilable(::String)).void }
