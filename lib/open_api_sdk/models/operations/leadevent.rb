  ...
  module Models
    module Operations
      ...
      class LeadEvent
        ...
        field :event, Models::Operations::ListEventsResponseBodyEvent, { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('event'), required: true, 'decoder': ::OpenApiSDK::Utils.enum_from_string(Models::Operations::ListEventsResponseBodyEvent, false) } }
        ...
        field :click, Models::Operations::ResponseBodyClick, { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('click'), required: true } }

        field :link, Models::Operations::ResponseBodyLink, { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('link'), required: true } }

        field :customer, Models::Operations::ListEventsResponseBodyCustomer, { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('customer'), required: true } }
        ...
        sig { params(event: Models::Operations::ListEventsResponseBodyEvent, timestamp: ::String, event_id: ::String, event_name: ::String, click: Models::Operations::ResponseBodyClick, link: Models::Operations::ResponseBodyLink, customer: Models::Operations::ListEventsResponseBodyCustomer, click_id: ::String, link_id: ::String, domain: ::String, key: ::String, url: ::String, continent: ::String, country: ::String, city: ::String, device: ::String, browser: ::String, os: ::String, qr: ::Float, ip: ::String, metadata: T.nilable(::Object)).void }
