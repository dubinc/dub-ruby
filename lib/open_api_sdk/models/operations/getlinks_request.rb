  ...
  module Models
    module Operations
      ...
      class GetLinksRequest
        ...
        sig { params(domain: T.nilable(::String), tag_id: T.nilable(::String), tag_ids: T.nilable(T.any(::String, T::Array[::String])), tag_names: T.nilable(T.any(::String, T::Array[::String])), folder_id: T.nilable(::String), search: T.nilable(::String), user_id: T.nilable(::String), tenant_id: T.nilable(::String), ending_before: T.nilable(::String), starting_after: T.nilable(::String), page: T.nilable(::Integer), show_archived: T.nilable(T::Boolean), with_tags: T.nilable(T::Boolean), page_size: T.nilable(::Integer)).void }
        def initialize(domain: nil, tag_id: nil, tag_ids: nil, tag_names: nil, folder_id: nil, search: nil, user_id: nil, tenant_id: nil, ending_before: nil, starting_after: nil, page: nil, show_archived: false, with_tags: false, page_size: 100)
          @domain = domain
          @tag_id = tag_id
          @tag_ids = tag_ids
          @tag_names = tag_names
