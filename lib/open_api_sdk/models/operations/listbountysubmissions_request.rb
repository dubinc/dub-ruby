  ...
  module Models
    module Operations
      ...
      class ListBountySubmissionsRequest
        ...
        sig { params(bounty_id: ::String, status: T.nilable(Models::Operations::ListBountySubmissionsQueryParamStatus), group_id: T.nilable(::String), partner_id: T.nilable(::String), page: T.nilable(::Float), sort_by: T.nilable(Models::Operations::ListBountySubmissionsQueryParamSortBy), sort_order: T.nilable(Models::Operations::ListBountySubmissionsQueryParamSortOrder), page_size: T.nilable(::Float)).void }
        def initialize(bounty_id:, status: nil, group_id: nil, partner_id: nil, page: nil, sort_by: Models::Operations::ListBountySubmissionsQueryParamSortBy::COMPLETED_AT, sort_order: Models::Operations::ListBountySubmissionsQueryParamSortOrder::ASC, page_size: 100.0)
          @bounty_id = bounty_id
          @status = status
          @group_id = group_id
