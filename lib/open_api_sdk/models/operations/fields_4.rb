  ...
  module Models
    module Operations
      ...
      class Fields4
        ...
        field :type, Models::Operations::ListPartnersFieldsPartnersResponseType, { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('type'), required: true, 'decoder': ::OpenApiSDK::Utils.enum_from_string(Models::Operations::ListPartnersFieldsPartnersResponseType, false) } }

        sig { params(key: ::String, label: ::String, required: T::Boolean, locked: T::Boolean, position: ::Integer, type: Models::Operations::ListPartnersFieldsPartnersResponseType).void }
