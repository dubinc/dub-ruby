...
module OpenApiSDK
  module Operations
    ...
    class ResponseBody < ::OpenApiSDK::Utils::FieldAugmented
      ...
      sig { params(created_at: ::String, external_id: ::String, id: ::String, name: ::String, avatar: T.nilable(::String), country: T.nilable(::String), email: T.nilable(::String)).void }
      def initialize(created_at: nil, external_id: nil, id: nil, name: nil, avatar: nil, country: nil, email: nil)
