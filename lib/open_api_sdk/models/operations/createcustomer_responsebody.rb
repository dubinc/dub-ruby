  ...
  module Models
    module Operations
      ...
      class CreateCustomerResponseBody
        ...
        field :link, Crystalline::Nilable.new(Models::Operations::CreateCustomerLink), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('link') } }

        field :program_id, Crystalline::Nilable.new(::String), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('programId') } }

        field :partner, Crystalline::Nilable.new(Models::Operations::CreateCustomerPartner), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('partner') } }

        field :discount, Crystalline::Nilable.new(Models::Operations::CreateCustomerDiscount), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('discount') } }

        sig { params(id: ::String, external_id: ::String, name: ::String, created_at: ::String, email: T.nilable(::String), avatar: T.nilable(::String), country: T.nilable(::String), sales: T.nilable(::Float), sale_amount: T.nilable(::Float), link: T.nilable(Models::Operations::CreateCustomerLink), program_id: T.nilable(::String), partner: T.nilable(Models::Operations::CreateCustomerPartner), discount: T.nilable(Models::Operations::CreateCustomerDiscount)).void }
