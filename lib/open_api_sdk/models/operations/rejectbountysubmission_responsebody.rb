  ...
  module Models
    module Operations
      ...
      class RejectBountySubmissionResponseBody
        ...
        field :status, Models::Operations::RejectBountySubmissionStatus, { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('status'), required: true, 'decoder': ::OpenApiSDK::Utils.enum_from_string(Models::Operations::RejectBountySubmissionStatus, false) } }
        ...
        sig { params(id: ::String, bounty_id: ::String, partner_id: ::String, status: Models::Operations::RejectBountySubmissionStatus, created_at: ::String, period_number: ::Integer, description: T.nilable(::String), urls: T.nilable(T::Array[::String]), files: T.nilable(T::Array[Models::Operations::RejectBountySubmissionFiles]), performance_count: T.nilable(::Float), social_metric_count: T.nilable(::Integer), completed_at: T.nilable(::String), reviewed_at: T.nilable(::String), rejection_reason: T.nilable(::String), rejection_note: T.nilable(::String), social_metrics_last_synced_at: T.nilable(::String)).void }
