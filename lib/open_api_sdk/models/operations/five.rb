  ...
  module Models
    module Operations
      ...
      class Five
        ...
        field :type, Models::Operations::ListPartnersFieldsPartnersResponse200Type, { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('type'), required: true, 'decoder': ::OpenApiSDK::Utils.enum_from_string(Models::Operations::ListPartnersFieldsPartnersResponse200Type, false) } }

        sig { params(key: ::String, label: ::String, required: T::Boolean, locked: T::Boolean, position: ::Integer, type: Models::Operations::ListPartnersFieldsPartnersResponse200Type).void }
