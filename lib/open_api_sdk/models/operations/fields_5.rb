  ...
  module Models
    module Operations
      ...
      class Fields5
        ...
        field :type, Models::Operations::CreatePartnerFieldsPartnersResponse201ApplicationJSONType, { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('type'), required: true, 'decoder': ::OpenApiSDK::Utils.enum_from_string(Models::Operations::CreatePartnerFieldsPartnersResponse201ApplicationJSONType, false) } }

        sig { params(key: ::String, label: ::String, required: T::Boolean, locked: T::Boolean, position: ::Integer, type: Models::Operations::CreatePartnerFieldsPartnersResponse201ApplicationJSONType).void }
