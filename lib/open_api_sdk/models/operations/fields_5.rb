  ...
  module Models
    module Operations
      ...
      class Fields5
        ...
        sig { params(key: ::String, label: ::String, required: T::Boolean, locked: T::Boolean, position: ::Integer, type: Models::Operations::ListPartnersFieldsPartnersResponse200ApplicationJSONType).void }
