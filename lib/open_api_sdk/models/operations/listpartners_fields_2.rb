  ...
  module Models
    module Operations
      ...
      class ListPartnersFields2
        ...
        field :constraints, Crystalline::Nilable.new(Models::Operations::ListPartnersFieldsPartnersConstraints), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('constraints') } }

        sig { params(key: ::String, label: ::String, required: T::Boolean, locked: T::Boolean, position: ::Integer, type: Models::Operations::ListPartnersFieldsPartnersType, constraints: T.nilable(Models::Operations::ListPartnersFieldsPartnersConstraints)).void }
