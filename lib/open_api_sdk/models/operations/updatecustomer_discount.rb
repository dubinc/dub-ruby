  ...
  module Models
    module Operations
      ...
      class UpdateCustomerDiscount
        ...
        field :type, Models::Operations::UpdateCustomerType, { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('type'), required: true, 'decoder': ::OpenApiSDK::Utils.enum_from_string(Models::Operations::UpdateCustomerType, false) } }
        ...
        sig { params(id: ::String, amount: ::Float, type: Models::Operations::UpdateCustomerType, max_duration: T.nilable(::Float), coupon_id: T.nilable(::String), coupon_test_id: T.nilable(::String), description: T.nilable(::String), partners_count: T.nilable(::Float)).void }
