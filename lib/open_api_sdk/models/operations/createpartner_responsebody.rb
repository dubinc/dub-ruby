  ...
  module Models
    module Operations
      ...
      class CreatePartnerResponseBody
        ...
        field :banned_reason, Crystalline::Nilable.new(Models::Operations::CreatePartnerBannedReason), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('bannedReason'), 'decoder': Utils.enum_from_string(Models::Operations::CreatePartnerBannedReason, true) } }
