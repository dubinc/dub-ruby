  ...
  module Models
    module Shared
      ...
      class Eight
        ...
        field :type, Models::Shared::PartnerEnrolledEventFieldsDataReferralFormData8Type, { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('type'), required: true, 'decoder': ::OpenApiSDK::Utils.enum_from_string(Models::Shared::PartnerEnrolledEventFieldsDataReferralFormData8Type, false) } }

        sig { params(key: ::String, label: ::String, required: T::Boolean, locked: T::Boolean, position: ::Integer, type: Models::Shared::PartnerEnrolledEventFieldsDataReferralFormData8Type).void }
