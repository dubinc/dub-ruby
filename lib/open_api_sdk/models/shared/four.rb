  ...
  module Models
    module Shared
      ...
      class Four
        ...
        field :type, Models::Shared::PartnerEnrolledEventFieldsDataReferralFormDataType, { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('type'), required: true, 'decoder': ::OpenApiSDK::Utils.enum_from_string(Models::Shared::PartnerEnrolledEventFieldsDataReferralFormDataType, false) } }

        sig { params(key: ::String, label: ::String, required: T::Boolean, locked: T::Boolean, position: ::Integer, type: Models::Shared::PartnerEnrolledEventFieldsDataReferralFormDataType).void }
