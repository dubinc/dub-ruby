  ...
  module Models
    module Shared
      ...
      class LinkClickedEvent
        ...
        field :event, Models::Shared::LinkClickedEventEvent, { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('event'), required: true, 'decoder': Utils.enum_from_string(Models::Shared::LinkClickedEventEvent, false) } }
