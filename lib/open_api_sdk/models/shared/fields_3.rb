  ...
  module Models
    module Shared
      ...
      class Fields3
        ...
        sig { params(key: ::String, label: ::String, required: T::Boolean, locked: T::Boolean, position: ::Integer, type: Models::Shared::PartnerEnrolledEventFieldsDataType, options: T::Array[Models::Shared::Options]).void }
