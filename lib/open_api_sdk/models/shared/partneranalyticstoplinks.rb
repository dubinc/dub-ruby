  ...
  module Models
    module Shared
      ...
      class PartnerAnalyticsTopLinks
        ...
        def initialize(link:, id:, domain:, key:, short_link:, url:, created_at:, title: nil, comments: nil, folder_id: nil, partner_id: nil, clicks: 0.0, leads: 0.0, sales: 0.0, sale_amount: 0.0, earnings: 0.0)
          @link = link
          @id = id
          @domain = domain
          @key = key
