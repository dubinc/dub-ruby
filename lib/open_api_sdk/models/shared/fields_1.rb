  ...
  module Models
    module Shared
      ...
      class Fields1
        ...
        field :type, Models::Shared::FieldsType, { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('type'), required: true, 'decoder': ::OpenApiSDK::Utils.enum_from_string(Models::Shared::FieldsType, false) } }

        field :constraints, Crystalline::Nilable.new(Models::Shared::Constraints), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('constraints') } }

        sig { params(key: ::String, label: ::String, required: T::Boolean, locked: T::Boolean, position: ::Integer, type: Models::Shared::FieldsType, constraints: T.nilable(Models::Shared::Constraints)).void }
