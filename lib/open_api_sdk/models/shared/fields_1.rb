  ...
  module Models
    module Shared
      ...
      class Fields1
        ...
        field :type, Models::Shared::FieldsType, { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('type'), required: true, 'decoder': Utils.enum_from_string(Models::Shared::FieldsType, false) } }
