  ...
  module Models
    module Shared
      ...
      class AnalyticsOS
        ...
        sig { params(os: ::String, clicks: T.nilable(::Float), leads: T.nilable(::Float), sales: T.nilable(::Float), sale_amount: T.nilable(::Float)).void }
        def initialize(os:, clicks: 0.0, leads: 0.0, sales: 0.0, sale_amount: 0.0)
          @os = os
          @clicks = clicks
          @leads = leads
          @sales = sales
