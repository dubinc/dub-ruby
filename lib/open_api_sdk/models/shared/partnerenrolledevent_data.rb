  ...
  module Models
    module Shared
      ...
      class PartnerEnrolledEventData
        ...
        field :status, Models::Shared::Status, { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('status'), required: true, 'decoder': Utils.enum_from_string(Models::Shared::Status, false) } }
