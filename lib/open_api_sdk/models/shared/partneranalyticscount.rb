  ...
  module Models
    module Shared
      ...
      class PartnerAnalyticsCount
        ...
        sig { params(clicks: T.nilable(::Float), leads: T.nilable(::Float), sales: T.nilable(::Float), sale_amount: T.nilable(::Float), earnings: T.nilable(::Float)).void }
        def initialize(clicks: 0.0, leads: 0.0, sales: 0.0, sale_amount: 0.0, earnings: 0.0)
          @clicks = clicks
          @leads = leads
          @sales = sales
