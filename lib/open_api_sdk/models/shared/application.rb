  ...
  module Models
    module Shared
      ...
      class Application
        ...
        field :rejection_reason, Crystalline::Nilable.new(Models::Shared::RejectionReason), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('rejectionReason'), required: true, 'decoder': ::OpenApiSDK::Utils.enum_from_string(Models::Shared::RejectionReason, false) } }
        ...
        sig { params(rejection_reason: T.nilable(Models::Shared::RejectionReason), rejection_note: T.nilable(::String), reviewed_at: T.nilable(::String)).void }
