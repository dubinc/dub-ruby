...
module OpenApiSDK
  ...
  class Workspaces
    ...
    sig { params(request: Models::Operations::GetWorkspaceRequest, timeout_ms: T.nilable(Integer)).returns(Models::Shared::WorkspaceSchema) }
    def get(request:, timeout_ms: nil)
      ...
      if Utils.match_status_code(http_response.status, ['200'])
        if Utils.match_content_type(content_type, 'application/json')
          ...
          obj = Crystalline.unmarshal_json(JSON.parse(response_data), Models::Shared::WorkspaceSchema)
    ...
    sig { params(id_or_slug: ::String, request_body: T.nilable(Models::Operations::UpdateWorkspaceRequestBody), timeout_ms: T.nilable(Integer)).returns(Models::Shared::WorkspaceSchema) }
    def update(id_or_slug:, request_body: nil, timeout_ms: nil)
      # update - Update a workspace
      # Update a workspace by ID or slug.
      request = Models::Operations::UpdateWorkspaceRequest.new(
      ...
      base_url = Utils.template_url(url, params)
      url = Utils.generate_url(
        Models::Operations::UpdateWorkspaceRequest,
        base_url,
        '/workspaces/{idOrSlug}',
        request
      )
